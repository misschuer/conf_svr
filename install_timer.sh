...
then 
    ...
    nohup /bin/sh ${path}/gm_gift_notice.sh >> /var/log/gm_gift_notice.log 2>&1 &
fi
sleep 1
...
then 
    ...
    nohup /bin/sh ${path}/gm_kicking_gag_lockaccount.sh >> /var/log/gm_kicking_gag_lockaccount.log 2>&1 &
fi
